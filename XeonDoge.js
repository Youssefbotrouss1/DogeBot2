//-----(BOT by Youssef  Bot Inc.)-----\\
//-----(Youtube Channel: Youssef)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*Youssef Bot*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `Youssef Bot Inc.`, "footerText": "*Youssef Bot*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "Youssef Bot"; break;
                case 1: jamss = "Youssef Bot"; break;
                case 2: jamss = "Youssef Bot"; break;
                case 3: jamss = "Youssef Bot"; break;
                case 4: jamss = "Youssef Bot"; break;
                case 5: jamss = "Youssef Bot"; break;
                case 6: jamss = "Youssef Bot"; break;
                case 7: jamss = "Youssef Bot"; break;
                case 8: jamss = "Youssef Bot"; break;
                case 9: jamss = "Youssef Bot"; break;
                case 10: jamss = "Youssef Bot"; break;
                case 11: jamss = "Youssef Bot"; break;
                case 12: jamss = "Youssef Bot"; break;
                case 13: jamss = "Youssef Bot"; break;
                case 14: jamss = "Youssef Bot"; break;
                case 15: jamss = "Youssef Bot"; break;
                case 16: jamss = "Youssef Bot"; break;
                case 17: jamss = "Youssef Bot"; break;
                case 18: jamss = "Youssef Bot"; break;
                case 19: jamss = "Youssef Bot"; break;
                case 20: jamss = "Youssef Bot"; break;
                case 21: jamss = "Youssef Bot"; break;
                case 22: jamss = "Youssef Bot"; break;
                case 23: jamss = "Youssef Bot"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*Youssef Bot*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Youssef Bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/201289267791`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*Youssef Bot*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
ini_list.push({
"displayName": `Youssef Bot Developer`,
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Youssef Bot`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Youssefbotrouss1/DogeBot2"
        },
        "index": 0
      }
    ]
...
const btnbc = {
    ...
    footerText: '*_Youssef Bot BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Youssef Bot`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Youssef Bot`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Youssef Bot`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `Youssef Bot`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
